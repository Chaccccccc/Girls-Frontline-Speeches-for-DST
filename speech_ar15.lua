...
return
{
	ACTIONFAIL =
	{
		...
		READ =
		{
			...
			NOBIRDS = "现在不行。",		--召唤不出鸟+
			NOWATERNEARBY = "这里水都没有，魔法也弄不出鱼来。",	--附近没有水，无法生成鱼群+
			TOOMANYBIRDS = "看来附近的鸟基本都在这了。",	--附近超过20只鸟则大幅减少读书后的召唤量，以防崩内存+
			WAYTOOMANYBIRDS = "附近已经没有其他的鸟了。",	--附近超过30只鸟则禁止读书召唤，以防崩内存+
			NOFIRES =	   "没有灭火的必要。",	--附近没有火焰+
			NOSILVICULTURE = "这附近没有树木可以成为目标。",	--附近没有树木或树精+
			NOHORTICULTURE = "附近没有能种的作物。",	--附近没有作物+
			NOTENTACLEGROUND = "现在的地方可不会有触手。",	--附近没有可生成触手的地形+
			NOSLEEPTARGETS = "附近没有需要催眠的猎物。",	--附近没有可以睡眠的生物+
			TOOMANYBEES = "蜜蜂的数量已经足够了，不需要再增加了。",	--嗡嗡蜜蜂数量达到上限+
			NOMOONINCAVES = "地下可没有月亮。",	--洞穴里无法改变月相+
			ALREADYFULLMOON = "这是白费力气。",	--已经是满月了+
		},

		GIVE =
		{
			GENERIC = "东西不该放在那里。",		--给予失败+
			DEAD = "我还是自己留着吧。",		--给予失败，目标死亡+
			SLEEPING = "他现在忙着呢。",		--给予失败，目标睡觉+
	...
	DESCRIBE =
	{
		...
		CHARLIE_NPC = "我应该在哪见过她。",	-- 物品名:"查理"
		CHARLIE_HAND = "看来它今天不是来偷火的。",	-- 物品名:"召唤之手"

		NITRE_FORMATION = "这池子里的鱼是怎么活下来的。",	-- 物品名:"硝石堆"+
		DREADSTONE_STACK = "就像坍缩晶石一样...",	-- 物品名:"绝望石生成"+

		SCRAPBOOK_PAGE = "一些资料的残页。",	-- 物品名:"丢失的图鉴页面"+

		LEIF_IDOL = "看来他，没少和树人做斗争。",	-- 物品名:"树精守卫雕像" 制造描述:"召唤树木的力量。"+
		WOODCARVEDHAT = "木制安全帽。",	-- 物品名:"硬木帽" 制造描述:"你的脑袋会被保护得很好（敲敲木头防止乌鸦嘴）。"+
		WALKING_STICK = "那位先生确实很擅长木工。",	-- 物品名:"木手杖" 制造描述:"轻松穿越您最喜欢的自然小径。"+

		IPECACSYRUP = "很显然那个小树人对朋友这个概念有误解。",	-- 物品名:"吐根糖浆" 制造描述:"让你保持正常。"+
		BOMB_LUNARPLANT_WORMWOOD = "我们的朋友似乎对他的月亮根源有了更多的接触。", -- Unused
		WORMWOOD_MUTANTPROXY_CARRAT =
		{
			DEAD = "它现在回归本质了。",	-- 物品名:"胡萝卜鼠" 制造描述:"将一个普通的胡萝卜变成有用的胡萝卜鼠！"->死亡+
			GENERIC = "哈？这又是什么奇怪的生物？",	-- 物品名:"胡萝卜鼠" 制造描述:"将一个普通的胡萝卜变成有用的胡萝卜鼠！"->默认+
			HELD = "那它应该算是肉类还是蔬菜呢？",	-- 物品名:"胡萝卜鼠" 制造描述:"将一个普通的胡萝卜变成有用的胡萝卜鼠！"->携带+
			SLEEPING = "原来它还需要睡觉啊。",	-- 物品名:"胡萝卜鼠" 制造描述:"将一个普通的胡萝卜变成有用的胡萝卜鼠！"->睡觉+
		},
		WORMWOOD_MUTANTPROXY_LIGHTFLIER = "或许可以研究如何用它来照明。",	-- 物品名:"球状光虫" 制造描述:"将普通灯泡变成忠诚的球状光虫！"+
		WORMWOOD_MUTANTPROXY_FRUITDRAGON =
		{
			GENERIC = "看起来是某种蜥蜴类生物。",	-- 物品名:"沙拉蝾螈" 制造描述:"将沉闷的火龙果变成凶猛的沙拉蝾螈！"->绿色+
			RIPE = "颜色差异很大，大小也有差异，应该是成熟期。",	-- 物品名:"沙拉蝾螈" 制造描述:"将沉闷的火龙果变成凶猛的沙拉蝾螈！"->红色+
			SLEEPING = "它在休眠。",	-- 物品名:"沙拉蝾螈" 制造描述:"将沉闷的火龙果变成凶猛的沙拉蝾螈！"->睡觉+
		},

		SUPPORT_PILLAR_SCAFFOLD = "还在施工中。",	-- 物品名:"支柱脚手架" 制造描述:"我们都需要一些支持。"+
		SUPPORT_PILLAR = "支柱需要加固了。",	-- 物品名:"支柱"+
		SUPPORT_PILLAR_COMPLETE = "暂时不会有什么问题了。",	-- 物品名:"加固支柱"+
		SUPPORT_PILLAR_BROKEN = "已经倒塌了。",	-- 物品名:"支柱瓦砾"+

		SUPPORT_PILLAR_DREADSTONE_SCAFFOLD = "还在施工中。",	-- 物品名:"绝望石支柱脚手架" 制造描述:""+
		SUPPORT_PILLAR_DREADSTONE = "支柱需要加固了。",	-- 物品名:"绝望石支柱"+
		SUPPORT_PILLAR_DREADSTONE_COMPLETE = "这段时间不会有什么问题了。",	-- 物品名:"加固绝望石支柱"+
		SUPPORT_PILLAR_DREADSTONE_BROKEN = "已经倒塌了。",	-- 物品名:"绝望石支柱瓦砾"+

		WOLFGANG_WHISTLE = "可以用来临时指挥。",	-- 物品名:"训练哨" 制造描述:"释放你心底潜在的教练！"+

		-- Rifts 3

		MUTATEDDEERCLOPS = "你的眼睛去哪了？哦，在sop那呢。",	-- 物品名:"晶体独眼巨鹿"+
		MUTATEDWARG = "它变成的僵尸狗确实比普通的威风。",	-- 物品名:"附身座狼"+
		MUTATEDBEARGER = "它看起来不像是会吼叫的样子。",	-- 物品名:"装甲熊獾"+

		LUNARFROG = "别来烦我，去找sop去，她喜欢眼睛多的。",	-- 物品名:"明眼青蛙"+

		DEERCLOPSCORPSE =
		{
			GENERIC  = "冬天尸体确实腐烂的慢一些。",	-- 物品名:"独眼巨鹿"->尸体+
			BURNING  = "但是不会影响燃烧。",	-- 物品名:"独眼巨鹿"->尸体燃烧+
			REVIVING = "啧，麻烦。",	-- 物品名:"独眼巨鹿"->尸体复活+
		},

		WARGCORPSE =
		{
			GENERIC  = "是那些野狗不敢吃他们的首领吗？",	-- 物品名:"座狼"->尸体+
			BURNING  = "只能我亲自动手了。",	-- 物品名:"座狼"->尸体燃烧+
			REVIVING = "我就知道。",	-- 物品名:"座狼"->尸体复活+
		},

		BEARGERCORPSE =
		{
			GENERIC  = "奇怪，尸体还在。",	-- 物品名:"熊獾"->尸体+
			BURNING  = "送它回归自然。",	-- 物品名:"熊獾"->尸体燃烧+
			REVIVING = "这也有变异熊?",	-- 物品名:"熊獾"->尸体复活+
		},

		BEARGERFUR_SACK = "这头熊再也不会肚子空空了。",	-- 物品名:"极地熊獾桶" 制造描述:"便携式冰箱。酷。"+
		HOUNDSTOOTH_BLOWPIPE = "我确实没想到有一天会用狗牙当子弹。",	-- 物品名:"榴弹炮" 制造描述:"那感觉就像远距离被咬一样。"+
		DEERCLOPSEYEBALL_SENTRYWARD =
		{
			GENERIC = "如果我多放几个眼球，它能否成为武器呢？",	-- Enabled.	-- 物品名:"冰眼结晶器"->有眼珠+
			NOEYEBALL = "它需要抓着自己的眼球。",  -- Disabled.	-- 物品名:"冰眼结晶器"->无眼珠+
		},
		DEERCLOPSEYEBALL_SENTRYWARD_KIT = "生物降温器。",	-- 物品名:"冰眼结晶器套装" 制造描述:"用冻伤来治疗一下晒伤。"+

		SECURITY_PULSE_CAGE = "用这个来束缚能量小球。",	-- 物品名:"火花柜"+
		SECURITY_PULSE_CAGE_FULL = "抓到了。",	-- 物品名:"火花柜"+

		CARPENTRY_STATION =
		{
			GENERIC = "用来制作家具的。",	-- 物品名:"锯马"->默认 制造描述:"别瞎蹦跶了，做点家具吧。"+
			BURNT = "被火烧了。",	-- 物品名:"锯马"->烧毁 制造描述:"别瞎蹦跶了，做点家具吧。"+
		},

		WOOD_TABLE = -- Shared between the round and square tables.
		{
			GENERIC = "木制家具。",	-- 物品名:"木圆桌/木方桌"->无东西 制造描述:"一张置物的木圆桌。/一张置物的木方桌。"+
			HAS_ITEM = "摆了东西的木制家具。",	-- 物品名:"木圆桌/木方桌"->有东西 制造描述:"一张置物的木圆桌。/一张置物的木方桌。"+
			BURNT = "木制家具的残骸。",	-- 物品名:"木圆桌/木方桌"->烧毁 制造描述:"一张置物的木圆桌。/一张置物的木方桌。"+
		},

		WOOD_CHAIR =
		{
			GENERIC = "一把木制椅子。",	-- 物品名:"木椅"->无人 制造描述:"一把可以坐的木椅。"+
			OCCUPIED = "不知道坐上去感觉如何。",	-- 物品名:"木椅"->有人 制造描述:"一把可以坐的木椅。"+
			BURNT = "现在没法坐了。",	-- 物品名:"木椅"->烧毁 制造描述:"一把可以坐的木椅。"+
		},

		DECOR_CENTERPIECE = "人形是很难看懂艺术之类的事物。",	-- 物品名:"艺术？" 制造描述:"彰显您卓越品味的餐桌摆件。"+
		DECOR_LAMP = "为什么用猫皮来做这个灯。",	-- 物品名:"餐桌灯" 制造描述:"一盏舒适的小灯。"+
		DECOR_FLOWERVASE =
		{
			GENERIC = "装饰用的家具。",	-- 物品名:"餐桌花瓶"->有花 制造描述:"这是一个放置鲜切花的好地方。"+
			EMPTY = "花是不是被SOP叼走了。",	-- 物品名:"餐桌花瓶"->无物品 制造描述:"这是一个放置鲜切花的好地方。"+
			WILTED = "它居然坚持到了现在，不容易。",	-- 物品名:"餐桌花瓶"->有花且已腐败 制造描述:"这是一个放置鲜切花的好地方。"+
			FRESHLIGHT = "现在它还有了照明的作用。",	-- 物品名:"餐桌花瓶"->有发光物品 制造描述:"这是一个放置鲜切花的好地方。"+
			OLDLIGHT = "SOP,去换个新的。",	-- 物品名:"餐桌花瓶"->有发光物品且已腐败 制造描述:"这是一个放置鲜切花的好地方。"+
		},
		DECOR_PICTUREFRAME =
		{
			GENERIC = "这谁画的？",	-- 物品名:"{item}画" 制造描述:"将你最爱的物品图装裱起来。"+
			UNDRAWN = "很明显它还没被SOP发现过。",	-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。"+
		},
		DECOR_PORTRAITFRAME = "我还以为已经有照相机了。",	-- 物品名:"愉快画像" 制造描述:"把你的朋友们放进框里，这很有趣！"+

		PHONOGRAPH = "我应该把唱片放哪？",	-- 物品名:"留声机" 制造描述:"坐下来，放松一下，听一听你噩梦中的音乐。"+
		RECORD = "不知道为什么，有人脸色很难看。",	-- 物品名:"唱片" 制造描述:"黑胶上的永恒经典。"+
		RECORD_CREEPYFOREST = "古老的留声技术。",	-- 物品名:"惊悚森林" 制造描述:"黑胶上的永恒经典。"+
		RECORD_DANGER = "不是我最喜欢的。",	-- 物品名:"唱片" 制造描述:"黑胶上的永恒经典。"
		RECORD_DAWN = "需要多一点小号。",	-- 物品名:"唱片" 制造描述:"黑胶上的永恒经典。"
		RECORD_DRSTYLE = "古老的留声技术。",	-- 物品名:"D.R.风格" 制造描述:"黑胶上的永恒经典。"
		...
		RECORD_WORKTOBEDONE = "不知道为什么，有人脸色很难看。",	-- 物品名:"唱片" 制造描述:"黑胶上的永恒经典。"+

		ARCHIVE_ORCHESTRINA_MAIN = "简单的密码装置，用穷举法就能破解。",	-- 物品名:"远古小合奏机"+

		WAGPUNKHAT = "破烂版战术头盔。",	-- 物品名:"W.A.R.B.I.S.头戴齿轮" 制造描述:"看起来聪明，打起来也聪明。"+
		ARMORWAGPUNK = "破烂版外骨骼。",	-- 物品名:"W.A.R.B.I.S.盔甲" 制造描述:"开足马力，全速前进！"+
		WAGSTAFF_MACHINERY = "已经不能用了，交给SOP吧。",	-- 物品名:"被丢弃的垃圾"+
		WAGPUNK_BITS = "可算是遇到正经的金属材料了。",	-- 物品名:"废铁"+
		WAGPUNKBITS_KIT = "我有点信不过它。",	-- 物品名:"自动修理机" 制造描述:"你得心应手的W.A.R.B.I.S.维修工具！"+

		WAGSTAFF_MUTATIONS_NOTE = "看起来是什么研究资料。",	-- 物品名:"研究笔记"+

		-- Meta 3

		BATTLESONG_INSTANT_REVIVE = "我对戏曲不感兴趣。",	--物品名:"战士重奏" 制造描述:"扰动阵亡战友的心房。"+

		WATHGRITHR_IMPROVEDHAT = "看来她更新了自己的装备。",	--物品名:"统帅头盔" 制造描述:"适合女武神女王的头盔。"+
		SPEAR_WATHGRITHR_LIGHTNING = "羊角加牛毛。",	--物品名:"奔雷矛" 制造描述:"闪电的力量由你掌控。"+

		BATTLESONG_CONTAINER = "专门用来存放歌谱的罐子。",	--物品名:"战斗号子罐" 制造描述:"保存你所有的金曲。"+

		SADDLE_WATHGRITHR = "听说过如虎添翼，没见过給牛添的。",	--物品名:"战斗鞍具" 制造描述:"勇士与坐骑，一起战斗吧！"+

		WATHGRITHR_SHIELD = "明明是盾，她却用来砸敌人。",	--物品名:"战斗圆盾" 制造描述:"只要它相信自己，盾牌也可以是武器。"

		BATTLESONG_SHADOWALIGNED = "在我的印象里，只有那些谜语人会喜欢这些。",	--物品名:"黑暗悲歌" 制造描述:"减少自身和盟友受到暗影攻击的伤害，增加对月亮阵营敌人的伤害。"+
		BATTLESONG_LUNARALIGNED = "在我的印象里，只有那些谜语人会喜欢这些。",	--物品名:"启迪摇篮曲" 制造描述:"减少自身和盟友受到月亮攻击的伤害，增加对暗影阵营敌人的伤害。"+
